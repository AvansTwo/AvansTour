            ...
            <div class="row">
                <div class="col-12 col-lg-6 order-1 order-lg-6">
                    ...
                    <div class="col-12">
                        ...
                        <a href="{{ url('/vraag/1') }}">NEED FOR SPEEEED</a>
                        <button type="button" href="{{ url('/vraag/1') }}" class=" btn create-btn mt-2"><i class="mr-5 fa-solid fa-square-plus"></i>Vragen toevoegen</button>
                    </div>
                </div>
