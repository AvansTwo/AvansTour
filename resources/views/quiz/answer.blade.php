...
<div class="container">
    ...
    <div class="row grey-bg my-5">
        ...
        <div class="col-12 col-lg-6 order-6 order-lg-1 p-5">
            <img class="img-fluid rounded mb-5 mb-lg-0" @if(!empty($progress->question->image_url)) src="{{asset('tourimg/'. $question->image_url)}}" @else src="{{asset('img/landing_img.png')}}" @endif alt="tour-detail-img">
        </div>
    </div>
    <script>
