    ...
    <div class="row">
        ...
        <div class="row grey-bg p-5 my-5">
            <div class="col-12 col-lg-8">
                ...
                <div class="col-12">
                    <small class="w-100 pt-3 d-block fst-italic">Jij of de leerkracht heeft de tour beëindigd, <strong>ga samen met je team terug naar de afgesproken verzamelplek.</strong></small>
                </div>
                <div class="col-12">
